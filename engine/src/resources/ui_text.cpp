...
namespace C3D
{
    ...
    void UIText::SetPosition(const vec3& pos) { transform.SetPosition(pos); }
    ...
    u32 UIText::GetMaxX() const { return static_cast<u32>(m_maxX); }

    u32 UIText::GetMaxY() const { return static_cast<u32>(m_maxY); }

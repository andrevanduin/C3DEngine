...
namespace C3D
{
    Platform::Platform() : BaseSystem(nullptr, "PLATFORM"), m_clockFrequency(0), m_startTime(0) {}

    Platform::Platform(const SystemManager* pSystemsManager)
        : BaseSystem(pSystemsManager, "PLATFORM"), m_clockFrequency(0), m_startTime(0)
    {}

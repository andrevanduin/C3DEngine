...
namespace C3D
{
    ...
    void VulkanImage::Create(const VulkanContext* context, const String& name, const TextureType type, const u32 _width,
                             const u32 _height, const VkFormat format, const VkImageTiling tiling,
                             const VkImageUsageFlags usage, const VkMemoryPropertyFlags memoryFlags,
                             const bool createView, const VkImageAspectFlags viewAspectFlags)
    {
        m_context     = context;
        m_name        = name;
        width         = _width;
    ...
    void VulkanImage::CreateView(const VulkanContext* context, TextureType type, const VkFormat format,
                                 const VkImageAspectFlags aspectFlags)
    {
        ...
        VK_SET_DEBUG_OBJECT_NAME(context, VK_OBJECT_TYPE_IMAGE_VIEW, view, viewName);
    }

    void VulkanImage::TransitionLayout(const VulkanContext* context, const VulkanCommandBuffer* commandBuffer,
                                       const TextureType type, VkFormat format, const VkImageLayout oldLayout,
    ...
    void VulkanImage::CopyFromBuffer(const TextureType type, VkBuffer buffer,
    ...
    void VulkanImage::CopyToBuffer(const TextureType type, VkBuffer buffer,
                                   const VulkanCommandBuffer* commandBuffer) const
    {
        VkBufferImageCopy region = {};
        region.bufferOffset      = 0;

...
namespace C3D
{
    bool DebugBox3D::Create(const vec3& size)
    {
        // TODO: name?
        m_id.Generate();
        m_size      = size;
    ...
    void DebugBox3D::SetPosition(const vec3& position) { Transforms.SetPosition(m_transform, position); }
    ...
    mat4 DebugBox3D::GetModel() const { return Transforms.GetWorld(m_transform); }

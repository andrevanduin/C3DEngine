...
void VulkanEngine::Draw()
{
	...
	DrawObjects(cmd, m_renderObjects.data(), m_renderObjects.size());
...
void VulkanEngine::InitVulkan()
{
	...
	VkPhysicalDeviceVulkan11Features requiredFeatures = {};
	requiredFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_FEATURES;
	requiredFeatures.pNext = nullptr;
	requiredFeatures.shaderDrawParameters = VK_TRUE;
	...
	std::cout << "[VULKAN] GPU: " << m_defaultGpuProperties.deviceName << std::endl;
	std::cout << "[VULKAN] Max Memory allocation Count: " << m_defaultGpuProperties.limits.maxMemoryAllocationCount << std::endl;\
	std::cout << "[VULKAN] Min Buffer Alignment of: " << m_defaultGpuProperties.limits.minUniformBufferOffsetAlignment << " bytes" << std::endl;
}
...
void VulkanEngine::InitScene()
{
	...
	for (int x = -10; x <= 10; x++)
	{
		for (int y = -10; y <= 10; y++)
		{
			...
			glm::mat4 translation = translate(glm::mat4{ 1.0f }, glm::vec3{ x, 5, y});
